...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.MEN_ESTADO_SINIESTRO_FIELD_CONFIDENCE,
			IProjectVariables.MEN_ESTADO_SINIESTRO_FIELD_INPUTMODE,
			IProjectVariables.MEN_ESTADO_SINIESTRO_FIELD_INTERPRETATION,
			IProjectVariables.MEN_ESTADO_SINIESTRO_FIELD_NOINPUTCOUNT,
			IProjectVariables.MEN_ESTADO_SINIESTRO_FIELD_NOMATCHCOUNT,
			IProjectVariables.MEN_ESTADO_SINIESTRO_FIELD_UTTERANCE,
			IProjectVariables.MEN_ESTADO_SINIESTRO_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MEN_ESTADO_SINIESTRO, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			...
			IProjectVariables.VAR_CONFIGURACION_FIELD_VDN_MENU_INFORMACION_ECOSISTEMA_OP_1,
			IProjectVariables.VAR_CONFIGURACION_FIELD_VDN_MENU_INFORMACION_ECOSISTEMA_OP_2,
		...
		variableFields = new String[] {
			IProjectVariables.MEN_INFORMACION_ECOSISTEMA_FIELD_CONFIDENCE,
			IProjectVariables.MEN_INFORMACION_ECOSISTEMA_FIELD_INPUTMODE,
			IProjectVariables.MEN_INFORMACION_ECOSISTEMA_FIELD_INTERPRETATION,
			IProjectVariables.MEN_INFORMACION_ECOSISTEMA_FIELD_NOINPUTCOUNT,
			IProjectVariables.MEN_INFORMACION_ECOSISTEMA_FIELD_NOMATCHCOUNT,
			IProjectVariables.MEN_INFORMACION_ECOSISTEMA_FIELD_UTTERANCE,
			IProjectVariables.MEN_INFORMACION_ECOSISTEMA_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MEN_INFORMACION_ECOSISTEMA, variableFields, null, session, false, false );
		session.putVariable(variable);

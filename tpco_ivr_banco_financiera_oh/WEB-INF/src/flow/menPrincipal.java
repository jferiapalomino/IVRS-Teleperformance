...
public class menPrincipal extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Información protección", "1", true, "exact", "codMenuPrincipal", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Reporte o solicitar información", "2", true, "exact", "codMenuPrincipal", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Registrar requerimiento y/o reclamo", "3", true, "exact", "codMenuPrincipal", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Solicitar la desactivación de su seguro", "4", true, "exact", "codMenuPrincipal", grammarInfo, true);
		list.add(choice);

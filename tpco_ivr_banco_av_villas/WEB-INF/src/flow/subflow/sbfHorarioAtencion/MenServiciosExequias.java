 ...
 */
public class MenServiciosExequias extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("prmMenuServicioExequias", ""));

 ...
 */
public class menInformacionEcosistema extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: (timestamp generation disabled)
	 */
	public menInformacionEcosistema() {
	...
	public void requestBegin(SCESession mySession) {
		...
		try{		
			Utils.agregarOpcion("MenuInformacionEcosistema", "Menú Información Ecosistema", mySession, "", "", "", "", "9", "5");
		}catch(Exception ex){
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("codMenuInformacionEcosistema", 0, true, ""));
		list.add(event);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("codMenuInformacionEcosistema", 0, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Gastos Funerarios", "1", true, "exact", "codMenuInformacionEcosistema", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Solicitar asistencia hogar", "2", true, "exact", "codMenuInformacionEcosistema", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Servicio Ecosistema", "3", true, "exact", "codMenuInformacionEcosistema", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Otro tipo de asistencia", "4", true, "exact", "codMenuInformacionEcosistema", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("prmMenInformacionEcosistema", ""));

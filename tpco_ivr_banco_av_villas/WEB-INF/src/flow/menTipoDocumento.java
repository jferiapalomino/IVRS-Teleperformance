...
public class menTipoDocumento extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Cedula Ciudadania", "1", true, "exact", "codMenuTipoDocumento", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Cedula Extranjera", "2", true, "exact", "codMenuTipoDocumento", grammarInfo, true);
		list.add(choice);

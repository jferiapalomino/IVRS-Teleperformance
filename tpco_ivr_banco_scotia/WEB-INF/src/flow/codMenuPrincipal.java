...
public class codMenuPrincipal extends com.avaya.sce.runtime.Data {
		...
		try{		
			...
			if(NoInput >= 1) {
				...
				if (NoMatch >= 1) {
					...
					switch (value) {
					case "1":
						mySession.getVariable(IProjectVariables.OPCION_MENU).getSimpleVariable().setValue("1. Para información de su protección");
						Utils.agregarOpcion("Opcion1", "Opción 1 - Para información de su protección", mySession, "", "", "", "1", "9", "5");
					...
					case "2":
						...
						break;
					case "3":
						mySession.getVariable(IProjectVariables.OPCION_MENU).getSimpleVariable().setValue("3. Para registrar un requerimiento y/o reclamo");
						Utils.agregarOpcion("Opcion3", "Opción 3 - Para registrar un requerimiento y/o reclamo", mySession, "", "", "", "3", "9", "5");
						mySession.getVariable(IProjectVariables.INTENTOS_MENU).getSimpleVariable().setValue("0");
						break;
					case "4":
						mySession.getVariable(IProjectVariables.OPCION_MENU).getSimpleVariable().setValue("4. Para Cancelar su protección");
						Utils.agregarOpcion("Opcion4", "Opción 4 - Para Cancelar su protección", mySession, "", "", "", "4", "9", "5");
						mySession.getVariable(IProjectVariables.INTENTOS_MENU).getSimpleVariable().setValue("0");
						break;
					case "9":
						mySession.getVariable(IProjectVariables.OPCION_MENU).getSimpleVariable().setValue("9. Si desea repetir este menú ");
						Utils.agregarOpcion("Opcion9", "Opción 9 - Si desea repetir este menú ", mySession, "", "", "", "9", "9", "5");
						mySession.getVariable(IProjectVariables.INTENTOS_MENU).getSimpleVariable().setValue("0");
						break;
				}
				}
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition6", "menPrincipal:value", com.avaya.sce.runtime.Expression.STRING_EQUAL, "4", false).setDebugId(5207)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("vdnDesborde", "varConfiguracion:vdnCancelarSeguro", false).setDebugId(5764));
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition7", "menPrincipal:value", com.avaya.sce.runtime.Expression.STRING_EQUAL, "9", false).setDebugId(5211)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
